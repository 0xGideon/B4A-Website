...
<svelte:head>
	...
	/>
	<meta property="og:image" content="https://b4aofficial.com/images/banner.svg" />
	...
	<meta
		...
		content="Blueprints for success in the Web3 frontier from the team at B4A."
	/>
	<meta name="twitter:image" content="https://b4aofficial.com/images/banner.svg" />
	...
	<script type="application/ld+json">
		{JSON.stringify({
			...
			sameAs: ['https://x.com/B4A001', 'https://t.me/+QQiaQ_9t3OdmYWQ0']
		})}
	</script>
</svelte:head>
			...
			<div class="grid gap-10 md:grid-cols-2 md:gap-6">
				...
				<div class="space-y-4 text-sm text-gray-200">
					...
					<div class="flex items-center gap-3 mt-6">
						...
						<a href="https://t.me/+QQiaQ_9t3OdmYWQ0" target="_blank" aria-label="Join us on Telegram" class="inline-flex h-8 w-8 items-center justify-center">
